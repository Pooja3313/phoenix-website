...
const ValuesSection = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-phoenix-gray-light via-background to-accent/5 relative overflow-hidden">
                ...
                >
                  ...
                  <div 
                    className={`absolute inset-0 transition-all duration-500 rounded-2xl 
                      ${isHovered ? "bg-gradient-to-br from-primary/5 via-accent/5 to-primary/10" : "bg-transparent"}`} 
                  />

                  {/* Big Background Letter Watermark */}
                  <span 
                    className={`absolute top-2 right-3 text-[120px] font-bold leading-none transition-all duration-500 select-none pointer-events-none
                  ...
                  <div 
                    className={`absolute top-4 right-4 w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-500 z-10
                  ...
                  <div className="relative mb-4 z-10">
                    <span 
                      className={`text-7xl md:text-8xl font-bold transition-all duration-500 inline-block leading-none
                  ...
                  {/* Animated Divider */}
                  <div 
                    className={`h-px mb-4 transition-all duration-500 relative z-10 
                      ${isHovered ? "bg-gradient-to-r from-primary via-accent to-primary" : "bg-gradient-to-r from-border via-border/50 to-transparent"}`} 
                  />

                  {/* Quote */}
                  <p 
                    className={`text-xs italic leading-relaxed transition-colors duration-300 relative z-10
                  ...
                  <div 
                    className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-primary via-accent to-primary transition-all duration-500
