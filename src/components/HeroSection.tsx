...
// ________________________________RECENT CODE BG COLOR_______________________________________________
...
// ___________________________________RECENT BG_IMAGE CODE________________________________________
...
//   return (
//     <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-background">
//       {/* Background Image - Professional team meeting (recommended) */}
//       <div
...
//       {/* Existing light gradients (subtle effect) */}
//       <div className="absolute inset-0 bg-gradient-to-br from-background via-phoenix-green-light/20 to-background" />
//       <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,hsl(var(--primary)/0.08),transparent_50%)]" />
//       <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,hsl(var(--phoenix-green)/0.06),transparent_50%)]" />

//       {/* Animated pound symbols */}
//       <div className="absolute top-20 right-20 text-phoenix-orange-light text-[200px] font-bold animate-pound-rotate select-none pointer-events-none opacity-30">
//        Â£
//       </div>
//       <div
//         className="absolute bottom-10 left-10 text-phoenix-orange-light text-[120px] font-bold animate-pound-rotate select-none pointer-events-none opacity-30"
//         style={{ animationDelay: "2s" }}
//       >
//         Â£
//       </div>
...
//       {/* Floating particles */}
//       <div
//         className="absolute top-1/4 right-1/3 w-2 h-2 rounded-full bg-primary/30 animate-bounce"
//         style={{ animationDuration: "3s" }}
//       />
//       <div
//         className="absolute top-2/3 right-1/4 w-3 h-3 rounded-full bg-phoenix-green/30 animate-bounce"
//         style={{ animationDuration: "4s", animationDelay: "1s" }}
//       />

//       <div className="container mx-auto px-4 relative z-10">
//         <div className="max-w-3xl mx-auto text-center">   {/* Center aligned content */}
//           <div
//             className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm border border-phoenix-green/20 rounded-full px-4 py-2 mb-6 animate-float-up"
//             style={{ animationDelay: "0.1s" }}
//           >
//             <Sparkles size={14} className="text-phoenix-green" />
//             <span className="text-phoenix-black text-sm font-medium">
...
//           <h1
//             className="text-5xl md:text-6xl lg:text-7xl font-bold text-black leading-tight mb-6 animate-float-up drop-shadow-lg"
//             style={{ animationDelay: "0.3s" }}
//           >
//             Best Solution to{" "}
//             <span className="highlighter-mark1 text-black font-handwritten text-5xl md:text-6xl lg:text-7xl">
//               Manage
//             </span>{" "}
//             Your Finance &{" "}
//             <span className="font-handwritten text-5xl md:text-6xl lg:text-7xl text-black pen-underline2">
//               Accounting
//             </span>
//           </h1>

//           <p
//             className="text-lg text-white mb-10 max-w-xl mx-auto leading-relaxed animate-float-up drop-shadow-md"
//             style={{ animationDelay: "0.5s" }}
//           >
//             From protection and mortgages to pensions and estate planning ? we
//             provide expert financial advice to secure your future and your
...
//           <div
//             className="flex flex-wrap gap-4 justify-center animate-float-up"
//             style={{ animationDelay: "0.7s" }}
//           >
//             <NavLink
//               to="/contact"
