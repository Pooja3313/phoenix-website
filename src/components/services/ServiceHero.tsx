...
const ServiceHero = ({ subtitle, title, description }: ServiceHeroProps) => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-phoenix-orange-glow py-20 md:py-28 lg:py-32">
      ...
      <div className="container relative z-10 max-w-4xl mx-auto text-center px-4">
        ...
        <AnimatedSection animation="animate-fade-in-up" delay={0.1}>
          <h1 className="font-script text-4xl md:text-5xl lg:text-6xl text-primary-foreground mb-6">
            {title}
          </h1>
        </AnimatedSection>
        ...
        <AnimatedSection animation="animate-fade-in-up" delay={0.3}>
          <Button
            size="lg"
