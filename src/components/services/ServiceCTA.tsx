...
const ServiceCTA = ({ title, description }: ServiceCTAProps) => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-primary to-phoenix-orange-glow py-16 md:py-20">
      ...
      <AnimatedSection
        className="container max-w-3xl mx-auto text-center px-4 relative z-10"
