      ...
      <main>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 max-w-4xl space-y-8">
            ...
            <AnimatedSection delay={0.2} animation="animate-fade-right">
            ...
            <AnimatedSection delay={0.25} animation="animate-fade-left">
            ...
            <AnimatedSection delay={0.45} animation="animate-fade-left">
            ...
            <AnimatedSection delay={0.5} animation="animate-fade-right">
            ...
            <AnimatedSection delay={0.55} animation="animate-fade-scale">
