...
const offerings = [
  {
    ...
    title: "Will Writing",
    description:
      "Ensure your assets are distributed according to your wishes with a professionally drafted will that reflects your intentions. A well-prepared will gives you control over your legacy.",
  },
  {
    icon: Shield,
    title: "Trust Planning",
    description:
      "Safeguard your wealth and secure your family's future with expert trust planning services tailored to your specific needs, financial goals and personal circumstances.",
  },
  {
    icon: Scale,
    title: "Inheritance Tax Planning",
    description:
      "Reduce potential inheritance tax liabilities through strategic planning, helping your loved ones retain more of your estate. Proper planning can make a significant difference.",
  },
  {
    icon: Users,
    title: "Lasting Power of Attorney",
    description:
      "Appoint trusted individuals to make decisions on your behalf with lasting power of attorney arrangements tailored to your preferences, covering both health and financial matters.",
  },
];
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <AnimatedSection delay={0.4} animation="animate-fade-left">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  While no one wants to think about a time when they might not
                  be around, it needs to be considered for the sake of your
                  loved ones. Without having wills or trusts or some kind of
                  estate planning in place, your assets might not be distributed
                  in the way you wish.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  should be tailored to your individual circumstances to ensure
            ...
            <div className="grid sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {offerings.map((item, index) => (
                ...
                >
                  <NavLink
                    to="/contact"
                    className="group relative bg-card border border-border rounded-2xl p-8 transition-all duration-500 hover:shadow-xl overflow-hidden cursor-pointer hover:border-primary/30 block h-full"
                  >
          ...
          <div className="container mx-auto px-4 text-center">
            <AnimatedSection delay={0.3}>
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Looking to Plan your Will & Estate?
              </h2>
              <p className="text-primary-foreground/80 max-w-2xl mx-auto mb-8 text-lg">
                Whether you're considering setting up a trust, arranging a
                lasting power of attorney or using our will writing service, our
                estate planning team is here to help. We take the time to
                understand your personal circumstances and provide tailored
                guidance.
              </p>
              <NavLink
                to="/contact"
