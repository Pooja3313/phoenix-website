    ...
    features: [
      {
        ...
        description:
          "Professionals understand the intricacies of writing a will and ensure your document complies with all legal requirements.",
      },
      {
        title: "Complex Situations",
        description:
          "We can help with more complex circumstances such as business ownership, blended families or overseas assets so every aspect is addressed.",
      },
      {
        title: "Avoiding Errors",
        description:
          "Poorly drafted wills can create ambiguity and disputes. Professional guidance reduces the risk of mistakes that could cause problems later.",
      },
      {
        title: "Peace of Mind",
        description:
          "Knowing your wishes are clearly documented and legally binding provides reassurance for you and your loved ones.",
      },
      {
        title: "Updates and Amendments",
        description:
          "As your life changes, your will can be reviewed and updated so it always reflects your current intentions.",
      },
    ],
    ...
    features: [
      {
        title: "Bare Trust",
        description:
          "Beneficiaries have an immediate right to the trust assets, making this a simple way to pass assets to children.",
      },
      {
        title: "Interest in Possession Trust",
        description:
          "Beneficiaries are entitled to income from the trust, while the underlying capital can be protected for others.",
      },
      {
        title: "Discretionary Trust",
        description:
          "Trustees have discretion over how and when benefits are distributed among a class of beneficiaries.",
      },
      {
        title: "Charitable Trust",
        description:
          "Assets are held for charitable purposes, allowing you to support causes that matter to you in a tax-efficient way.",
      },
      {
        title: "Life Interest Trust",
        description:
          "Provides income or benefit for one beneficiary during their lifetime, with capital passing to others afterwards.",
      },
      {
        title: "Asset Protection Trust",
        description:
          "Helps shield assets from certain creditors and long‑term care costs, subject to legal and tax rules.",
      },
    ],
