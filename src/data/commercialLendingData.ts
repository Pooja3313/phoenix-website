...
export const commercialLendingServices: ServiceItem[] = [
  {
    ...
    features: [
      { title: "Auction Finance", description: "Complete your auction purchase within the required 28-day timeframe with fast bridging finance tailored to auction buyers." },
      { title: "Chain Break Finance", description: "Don't let a broken property chain derail your purchase — bridge the gap until your existing property sells." },
      { title: "Refurbishment Finance", description: "Fund property renovations and improvements with bridging loans that take into account the projected uplift in value." },
      { title: "Commercial Bridging", description: "Short-term finance for commercial property acquisitions, conversions, and investment opportunities." },
    ],
  ...
  },
  {
    ...
    features: [
      { title: "Term Loans", description: "Traditional business loans with fixed or variable rates, repaid over an agreed period — ideal for planned investments and expansion." },
      { title: "Revolving Credit Facilities", description: "Flexible borrowing that allows you to draw down and repay funds as needed, only paying interest on what you use." },
      { title: "Invoice Finance", description: "Release cash tied up in unpaid invoices to improve your working capital position and maintain healthy cash flow." },
      { title: "Start-Up Finance", description: "Funding options for new businesses, including government-backed Start Up Loans and alternative finance solutions." },
    ],
  ...
  },
  {
    ...
    features: [
      { title: "Ground-Up Development", description: "Finance for new-build residential and commercial projects, with funds released in stages as construction milestones are met." },
      { title: "Conversion & Refurbishment", description: "Funding for converting commercial properties to residential use, or refurbishing existing properties to increase their value." },
      { title: "Mezzanine Finance", description: "Additional funding layered on top of senior debt to increase the total loan-to-cost ratio, reducing the developer's equity requirement." },
      { title: "Joint Venture Finance", description: "Structured finance arrangements where the lender provides a higher proportion of funding in exchange for a share of the development profit." },
    ],
  ...
  },
  {
    ...
    features: [
      { title: "Hire Purchase", description: "Spread the cost of an asset over time with fixed monthly payments. You own the asset outright once all payments are made." },
      { title: "Finance Lease", description: "Use the asset for an agreed period while the finance company retains ownership. Ideal if you regularly upgrade equipment." },
      { title: "Operating Lease", description: "Rent equipment for a shorter period than its useful life, with the option to return, upgrade, or extend at the end of the term." },
      { title: "Refinancing", description: "Release capital tied up in existing assets by refinancing them, providing a cash injection without selling the equipment." },
    ],
  ...
  },
  {
    ...
    features: [
      { title: "Individual Buy-to-Let", description: "Standard buy-to-let mortgages for individual landlords purchasing in their own name, with competitive rates from leading lenders." },
      { title: "Limited Company Purchase", description: "Increasingly popular for tax efficiency, we arrange finance for properties purchased through SPV companies or trading companies." },
      { title: "Multi-Unit Freehold Blocks", description: "Specialist financing for purchasing entire blocks of flats or maisonettes, with lending based on aggregate rental income." },
      { title: "Portfolio Refinancing", description: "Restructure your existing portfolio finance to release equity, reduce costs, or consolidate with fewer lenders." },
    ],
  ...
  },
  {
    ...
    features: [
      { title: "Owner-Occupied Mortgages", description: "Finance for purchasing premises from which your business will trade, often with more favourable terms than standard commercial lending." },
      { title: "Investment Mortgages", description: "Loans for purchasing commercial properties to let out to tenants, with lending assessed on the property's rental income potential." },
      { title: "Semi-Commercial Mortgages", description: "Finance for mixed-use properties that combine commercial and residential elements, such as a shop with a flat above." },
      { title: "Refinancing", description: "Switch your existing commercial mortgage to a better deal, release equity for business purposes, or restructure your borrowing." },
    ],
